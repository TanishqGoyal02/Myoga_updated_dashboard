...
public class RegisterPage3ActivitySample extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstance) {
        ...
        setContentView(R.layout.register_page3_sample);
        ...
        continue_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(RegisterPage3ActivitySample.this, "Please enter your first name", Toast.LENGTH_SHORT).show();
                    return;
                }
                if ( ( lastname.getText().toString().trim().equals("")) )
                {
                    Toast.makeText(RegisterPage3ActivitySample.this, "Please enter your last name", Toast.LENGTH_SHORT).show();
                    return;
                }
                if ( ( email.getText().toString().trim().equals("")) )
                {
                    Toast.makeText(RegisterPage3ActivitySample.this, "Please enter your email", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                {
                    Toast.makeText(RegisterPage3ActivitySample.this, "Please enter your age", Toast.LENGTH_SHORT).show();
                    return;
                }
                if ( ( weight.getText().toString().trim().equals("")) )
                {
                    Toast.makeText(RegisterPage3ActivitySample.this, "Please enter your weight", Toast.LENGTH_SHORT).show();
                    return;
                }
                if ( ( height.getText().toString().trim().equals("")) )
                {
                    Toast.makeText(RegisterPage3ActivitySample.this, "Please enter your height", Toast.LENGTH_SHORT).show();
                    return;
                }
                else {
                    Log.i("TEST", "Continue button clicked");
                    Intent intent = new Intent(RegisterPage3ActivitySample.this, RegisterPage2Activity.class);
