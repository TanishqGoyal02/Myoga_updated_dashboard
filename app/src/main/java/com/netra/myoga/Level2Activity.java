...
public class Level2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstance) {
        ...
        setContentView(R.layout.level2_homepage);
        ...
        day1B.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Level2Activity.this, WeeklyActivity.class);
    ...
    public void onBackPressed(){
        ...
        Intent intent = new Intent(Level2Activity.this, DashboardActivity.class);
        startActivity(intent);
    }
}
